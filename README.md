...
| **Slumpa** | Tärningen 🎲 i toppraden slumpar looken — allt utom Form och tid, Partiklar, bakgrundsfärgen och brytarna för kanter, glans och ytor. Efteråt lyser 🎲 i rubriken en stund på de avsnitt den ändrade, så att du ser vilka som lämnades orörda. **Välj vad som får slumpas** visar en tärning intill varje reglage: tänd = får slumpas, släckt = fredas. Bygget och exporten rörs aldrig; kamera och de tyngsta valen är släckta från början. Varje avsnitt har dessutom tre knappar i rubriken: 🎲 slumpar bara det avsnittet, ✕ återställer det till standard och ↶ ångrar det senaste som gjordes i avsnittet. Under flikarna finns 🎲 och ✕ för bara fliken du står på (t.ex. **🎲 Slumpa Bana**). Avsnittens tärningar rör även det som är släckt från början, men aldrig det du själv har släckt eller huvudbrytarna för partiklar, stereogram och bakgrundsborttagning. ↶ i toppraden ångrar det senaste, var det än gjordes, ett steg i taget. |
