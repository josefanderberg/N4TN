...
const sections = [
  {
    ...
    items: [
      ...
      // Glaset och ytorna hör till lådans skal precis som kantglöden; de bor i en
      // hopfällbar grupp så att panelen förblir kort på mobil.
      { type: 'group', label: 'Glas och ytor', items: [
        ...
        { type: 'range', key: 'shellSide', label: 'Yta sidor', min: 0, max: 1, step: 0.01,
          info: 'Hur mycket lådans fyra sidoväggar syns — bildkanterna utsmetade över tid.' },
      ] },
